...
int main(){
  ...
  multiply(A, result);
  printf("C (A times A transpose) = \n");
  for(int i = 0; i < size; i++){
    for(int j = 0; j < size; j++){
      printf("%-15g\t", result[i][j]);
    }
    printf("\n");
  }
  cofactor(result, size, 0.0);
  printf("\nC inverse = \n");
  for(int i = 0; i < size; i++){
    for(int j = 0; j < size; j++){
      printf("%-15g\t", inverseMatrix[i][j]);
    }
    printf("\n");
  }
  for(int i = 0; i < size; i++){
  ...
  cofactor(A, size, 0.0);
  multiply(inverseMatrix, result);
  printf("\n(Ai times Ai transpose) = \n");
  for(int i = 0; i < size; i++){
    for(int j = 0; j < size; j++){
      printf("%-15g\t", result[i][j]);
    }
